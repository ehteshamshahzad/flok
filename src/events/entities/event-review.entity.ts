...
export class EventReview extends BaseEntity {
    ...
    @ManyToOne(() => Event, (event: Event) => event.eventReviews, { createForeignKeyConstraints: false })
    ...
    @ManyToOne(() => User, (user: User) => user.eventReviews, { createForeignKeyConstraints: false })
