...
export class AuthService {
  ...
  async login(loginUserInput: LoginUserInput) {
    const user =
      await this.usersService.findUserIdNameUserTypeProfileImageDoBPasswordProvidersStaffIdByEmail(
        loginUserInput.email
      );

    const checkPassword = hashFunction(
  ...
  async register(
    ...
    const existingUserPromise = this.usersService.findUserIdByEmail(
